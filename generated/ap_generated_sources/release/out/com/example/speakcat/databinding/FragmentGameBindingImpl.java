...
public class FragmentGameBindingImpl extends FragmentGameBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_progressbar, 3);
        sViewsWithIds.put(R.id.pb, 4);
        sViewsWithIds.put(R.id.tv_progress, 5);
        sViewsWithIds.put(R.id.tv_optionOne, 6);
        sViewsWithIds.put(R.id.tv_optionTwo, 7);
        sViewsWithIds.put(R.id.tv_optionThree, 8);
        sViewsWithIds.put(R.id.tv_optionFour, 9);
